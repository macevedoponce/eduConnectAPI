...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2023 a las 10:02:44
...
(1, 'Buena presentación, falta un ejercicio', 'https://example.com/trabajo1', 8, 1, 3),
(2, 'Muy bien investigado', 'https://example.com/trabajo2', 9, 2, 3),
(3, 'Buena comprensión del tema', 'https://example.com/trabajo3', 7, 3, 4);
...
INSERT INTO `examen_pregunta` (`id`, `examen_id`, `pregunta_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 2),
(4, 2, 3),
...
(1, 'Pregunta 1', 'Respuesta correcta', 1),
(2, 'Pregunta 2', 'Respuesta incorrecta', 1),
(3, 'Pregunta 3', 'Respuesta correcta', 1);
...
(1, 'Tarea 1', 'Realizar ejercicios del capítulo 3', '2023-05-30', 1, 1),
...
(4, 'Investigación de medios de comunicación', 'Estimados estudiantes la tarea para esta sema es investigar un medio de comunicación en particular, como una revista, un periódico o un canal de televisión, y escribir un informe sobre su historia, objetivos y audiencia.', '2023-05-31', 2, 1);
